# NOTE: cyberrunner_state_estimation/cyberrunner_state_estimation/utils/ocam_model.py
...
class OcamModel:
    ...
    def world2cam(self, world_points, algorithm="invpoly"): # TODO: need to be repaced with OpenCV calibration equvalent. 
        ...
        """
        # make it crash to see if its useful
        assert 1 == 0, "This function is not implemented correctly yet"
    ...
    def cam2world(self, img_points): # TODO: need to be repaced with OpenCV calibration equvalent. x
...
def main():
    ...
    ocam_model = OcamModel("state_est/calib_razer_data.txt")
    ...
    print(points_3d)
    points_2d = ocam_model.world2cam(points_3d)
    print(points_2d)

    # and back
    points_3d_recovered = ocam_model.cam2world(points_2d)
    print("recovered 3d points")
    print(np.round(points_3d_recovered, 3))  # Simple approach
